...
## RGB LEDs
set_property -dict { PACKAGE_PIN F1    IOSTANDARD LVCMOS33 } [get_ports { rgb[0] }]; #IO_L10N_T1_34 Sch=led0_b
set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { rgb[1] }]; #IO_L9N_T1_DQS_34 Sch=led0_g
set_property -dict { PACKAGE_PIN F2    IOSTANDARD LVCMOS33 } [get_ports { rgb[2] }]; #IO_L10P_T1_34 Sch=led0_r
...
set_property -dict { PACKAGE_PIN C5    IOSTANDARD LVCMOS33 } [get_ports { pin }]; #IO_L5P_T0_34 Sch=pio[40]
